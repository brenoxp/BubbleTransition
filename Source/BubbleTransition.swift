...
open class BubbleTransition: NSObject {
  ...
  @objc public enum BubbleTransitionMode: Int {
    case present, dismiss, dismissWithPresentAnimation, pop
  }
}
...
extension BubbleTransition: UIViewControllerAnimatedTransitioning {
  ...
  public func animateTransition(using transitionContext: UIViewControllerContextTransitioning) {
    ...
    if transitionMode == .present {
    ...
    } else if transitionMode == .dismissWithPresentAnimation {
      ...
      let presentedControllerView = (navigationController.viewControllers[0]).view!
      ...
      let parentView = presentedControllerView.superview!
      containerView.addSubview(presentedControllerView)
      ...
      UIView.animate(withDuration: duration, animations: {
        ...
        parentView.addSubview(presentedControllerView)
        presentedControllerView.center = originalCenter
